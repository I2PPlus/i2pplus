...
<!--
  A simple XSLT stylesheet to transform SpotBugs XML results annotated with messages into HTML.
...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>I2P+ | SpotBugs Report</title>
        <style type="text/css">
  ...
  <xsl:template match="Project">
    ...
    <p class="smaller" id="version"> SpotBugs version: <xsl:value-of select="/BugCollection/@version" />
    </p>
    <hr />
