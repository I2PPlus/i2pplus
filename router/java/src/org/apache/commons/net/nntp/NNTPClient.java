...
public class NNTPClient extends NNTP {
    ...
    /**
     * Same as {@code retrieveArticle((String) null)} Note: the return can be cast to a {@link BufferedReader}
     *
     ...
     * in the server reply are returned through an ArticleInfo. The {@code articleId} field of the ArticleInfo cannot always be trusted because some NNTP
     ...
     * article number and identifier contained in the server reply are returned through an ArticleInfo. The {@code articleId} field of the ArticleInfo
    ...
    /**
     * Same as {@code retrieveArticleBody(null)} Note: the return can be cast to a {@link BufferedReader}
     *
     ...
     * contained in the server reply are returned through an ArticleInfo. The {@code articleId} field of the ArticleInfo cannot always be trusted because
    ...
    /**
     * Same as {@code selectArticle((String) null, articleId)}. Useful for retrieving the current article number.
     *
     ...
     * {@code selectArticle(pointer.articleNumber, pointer)} immediately afterward.
     *
     * @param pointer A parameter through which to return the article's number and unique id. The articleId field cannot always be trusted because of server
     *                deviations from RFC 977 reply formats. You may set this parameter to null if you do not desire to retrieve the returned article
     *                information.
