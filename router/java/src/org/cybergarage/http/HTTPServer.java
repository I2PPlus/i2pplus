...
public class HTTPServer implements Runnable {
     ...
     * @since 1.8
     */
    public final static int DEFAULT_TIMEOUT = 10 * 1000; // I2P fix
    ...
    public HTTPServer() {serverSock = null;}
     ...
     * @since 1.8
     */
    public synchronized void setTimeout(int timeout) {this.timeout = timeout;}

    public boolean open(InetAddress addr,int port) {
        if (serverSock != null) {return true;}
        try {serverSock = new ServerSocket(bindPort, 0, bindAddr);}
    ...
    public boolean isOpened() {return (serverSock != null) ? true : false;}
