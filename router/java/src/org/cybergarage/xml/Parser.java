...
public abstract class Parser {
    ...
    public Node parse(URL locationURL) throws ParserException {
        ...
        if (!"http".equals(locationURL.getProtocol())) throw new ParserException("Not HTTP");
        String host = locationURL.getHost();
        if (host == null || host.startsWith("127.")) throw new ParserException("Bad host " + host);
        ...
        if (!HURLC_PROXY_ENABLED) {
            ...
            try {
                ...
                // Alternative would be foo = new HttpURLConnection(locationURL); foo.set timeouts;
                // foo.connect()
                ...
                if (urlCon.getContentLength() > 32768) throw new ParserException("too big");
