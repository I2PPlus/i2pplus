...
public abstract class I2NPMessageImpl implements I2NPMessage {
    ...
    public I2NPMessageImpl(I2PAppContext context) {
        ...
        //_context.statManager().createRateStat("i2np.writeTime", "Time taken to write an I2NP message", "I2NP", new long[] { 60*1000, 10*60*1000, 60*60*1000 });
        //_context.statManager().createRateStat("i2np.readTime", "Time taken to read an I2NP message", "I2NP", new long[] { 60*1000, 10*60*1000, 60*60*1000 });
    }
