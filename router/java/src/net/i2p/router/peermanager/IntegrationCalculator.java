...
class IntegrationCalculator {
    ...
    public static double calc(PeerProfile profile) {
        ...
        if (profile.getIsExpandedDB()) {
            ...
            val += 2 * 24 * profile.getDbIntroduction().getRate(24*60*60*1000l).getCurrentEventCount();
...
//            val += 3 * 4 * profile.getDbIntroduction().getRate(6*60*60*1000l).getCurrentEventCount();
            val += 3 * 24 * profile.getDbIntroduction().getRate(60*60*1000l).getLastEventCount();
            val += 4 * 24 * profile.getDbIntroduction().getRate(60*60*1000l).getCurrentEventCount();
            val += 5 * 24 * profile.getDbIntroduction().getRate(10*60*1000l).getLastEventCount();
            val += 6 * 24 * profile.getDbIntroduction().getRate(10*60*1000l).getCurrentEventCount();
