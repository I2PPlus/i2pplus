...
class IntegrationCalculator {
    ...
    public static double calc(PeerProfile profile) {
        ...
        if (profile.getIsExpandedDB()) {
            ...
            val =  profile.getDbIntroduction().getRate(24*60*60*1000l).getLastEventCount() / 2;
            val += profile.getDbIntroduction().getRate(24*60*60*1000l).getCurrentEventCount() * 2;
            val += 24 * profile.getDbIntroduction().getRate(60*60*1000l).getLastEventCount() / 2;
            val += 24 * profile.getDbIntroduction().getRate(60*60*1000l).getCurrentEventCount() * 2;
            val += 6 * 24 * profile.getDbIntroduction().getRate(10*60*1000l).getLastEventCount() / 2;
