...
public class PriBlockingQueue<E extends PQEntry> extends PriorityBlockingQueue<E> {
    ...
    protected static final int BACKLOG_SIZE = SystemVersion.getMaxMemory() < 1024*1024*1024 ? 256 : 1024;
    protected static final int MAX_SIZE = SystemVersion.getMaxMemory() < 1024*1024*1024 ? 512 : 2048;
