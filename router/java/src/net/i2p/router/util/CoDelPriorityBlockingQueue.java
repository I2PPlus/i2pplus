...
//    private static final long TARGET = 15;
    private static final long TARGET = 50;
...
//    private static final long INTERVAL = 300;
    ...
    public CoDelPriorityBlockingQueue(I2PAppContext ctx, String name, int initialCapacity) {
        ...
        for (int i = 0; i < PRIORITIES.length; i++) {
            ctx.statManager().createRateStat(STAT_DROP + PRIORITIES[i], "Queue delay of dropped items by priority [" + PRIORITIES[i] + "]", "Router [CoDel]", CODEL_RATES);
        }
