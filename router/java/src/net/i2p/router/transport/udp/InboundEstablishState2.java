    ...
    public void gotRI(RouterInfo ri, boolean isHandshake, boolean flood) throws DataFormatException {
        ...
        for (RouterAddress addr : addrs) {
            ...
            if (infoIP != null && infoIP.length == _aliceIP.length) {
                ...
                mismatchMessage = new StringBuilder("IP mismatch actual IP ").append(Addresses.toString(_aliceIP)).append(" in RI: ").toString(); // NOPMD - AvoidUnnecessaryStringBuilderCreation
            }
            break;
        }
