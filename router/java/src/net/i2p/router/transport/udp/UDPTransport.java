...
//    private static final int MIN_INTRODUCER_POOL = 5;
    ...
    public UDPTransport(RouterContext ctx, DHSessionKeyBuilder.Factory dh) {
        ...
        //_context.statManager().createRateStat("udp.packetAuthTime", "Time taken to encrypt and MAC a packet for sending", "Transport [UDP]", RATES);
        //_context.statManager().createRateStat("udp.packetAuthTimeSlow", "Time taken to encrypt and MAC a packet for sending (when its slow)", "Transport [UDP]", RATES);
