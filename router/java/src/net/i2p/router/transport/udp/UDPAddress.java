...
class UDPAddress {
    ...
    public UDPAddress(RouterAddress addr) {
        ...
        try {
            ...
            if (mtu != null) {
                ...
                if (isIPv6 && imtu > 1420) {
                    ...
                    if (imtu > 1472 && _host.startsWith("2001:470:")) imtu = 1472;
                    else if (_host.startsWith("2a06:a004:")) imtu = 1420;
                }
                if (ssu2only) {
                ...
                if (_host.startsWith("2001:470:")) cmtu = 1472;
                else if (_host.startsWith("2a06:a004:")) cmtu = 1420;
            }
        ...
        for (int i = MAX_INTRODUCERS - 1; i >= 0; i--) {
            ...
            if (cintroTags == null) {
                ...
                if (ssu2enable) cintroHashes = new Hash[i + 1];
            }
            if (!ssu2only) {
                cintroHosts[i] = host;
                cintroPorts[i] = p;
            ...
            cintroTags[i] = tag;
            cintroExps[i] = exp;
            if (ssu2enable) cintroHashes[i] = hash;
        }
        ...
        if (cintroTags != null) {
            ...
            for (int i = 0; i < cintroTags.length; i++) {
                if (cintroTags[i] > 0 && ((cintroHashes != null && cintroHashes[i] != null) || (cintroKeys != null && cintroKeys[i] != null && cintroPorts[i] > 0 && cintroHosts[i] != null))) numOK++;
            }
            if (numOK != cintroTags.length) {
                int cur = 0;
                for (int i = 0; i < cintroTags.length; i++) {
                    if (cintroTags[i] > 0 && ((cintroHashes != null && cintroHashes[i] != null) || (cintroKeys != null && cintroKeys[i] != null && cintroPorts[i] > 0 && cintroHosts[i] != null))) {
                        if (cur != i) {
    ...
    InetAddress getHostAddress() {
        if (_hostAddress == null) _hostAddress = getByName(_host);
        return _hostAddress;
    }
    ...
    InetAddress getIntroducerHost(int i) {
        if (_introAddresses == null) return null;
        if (_introAddresses[i] == null) _introAddresses[i] = getByName(_introHosts[i]);
    ...
    public String toString() {
        ...
        if (_introHosts != null) {
            ...
            if ((_host != null) && (_port > 0)) rv.append("ssu://").append(_host).append(':').append(_port); // .append('/').append(Base64.encode(_introKey));
