...
//    private static final int MAX_THREADS = 5;
    ...
    public MessageReceiver(RouterContext ctx, UDPTransport transport) {
        ...
        //_context.statManager().createRateStat("udp.inboundReadTime", "Time taken to parse in the completed fragments into a message?", "Transport [UDP]", UDPTransport.RATES);
        //_context.statManager().createRateStat("udp.inboundReceiveProcessTime", "Time taken to add the message to the transport?", "Transport [UDP]", UDPTransport.RATES);
