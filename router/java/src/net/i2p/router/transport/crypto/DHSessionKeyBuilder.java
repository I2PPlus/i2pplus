...
******/
    ...
    public static class PrecalcRunner extends I2PThread implements Factory {
        ...
        public PrecalcRunner(I2PAppContext ctx) {
            ...
            ctx.statManager().createRateStat("crypto.dhGeneratePublicTime", "Time to create x and X", "Encryption", new long[] { 60*1000, 60*60*1000 });
            ctx.statManager().createRateStat("crypto.dhCalculateSessionTime", "Time to create the session key", "Encryption", new long[] { 60*1000, 60*60*1000 });
