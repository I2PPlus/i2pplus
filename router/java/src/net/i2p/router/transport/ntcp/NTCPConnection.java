...
//                                                                         MAX_DATA_READ_BUFS : MAX_DATA_READ_BUFS * 16), BUFFER_SIZE);
    private static final ByteCache _dataReadBufs = ByteCache.getInstance(Math.min(((int)SystemVersion.getMaxMemory() / 1024 / 1024 / 32) * MAX_DATA_READ_BUFS, 32), BUFFER_SIZE);
