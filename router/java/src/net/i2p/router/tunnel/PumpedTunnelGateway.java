...
*/
    ...
    private static final int INITIAL_OB_QUEUE = (mem < 1024*1024*1024 || cores <= 4 || isSlow) ? 64 : 96;
    private static final int MAX_IB_QUEUE = (mem < 1024*1024*1024 || cores <= 4 || isSlow) ? 1024 : 1384;
