...
class TunnelGatewayPumper implements Runnable {
    ...
    public TunnelGatewayPumper(RouterContext ctx) {
        ...
        _wantsPumping = new LinkedHashSet<>(QUEUE_BUFFER);
        _backlogged = new HashSet<>(QUEUE_BUFFER);
    ...
    private void run2() {
        ...
        List<PendingGatewayMessage> queueBuf = new ArrayList<PendingGatewayMessage>(QUEUE_BUFFER);
