...
public class TunnelDispatcher implements Service {
    ...
    public TunnelDispatcher(RouterContext ctx) {
        ...
        //ctx.statManager().createRateStat("tunnel.dispatchGatewayTime", "Time taken to dispatch a TunnelGatewayMessage", "Tunnels", RATES);
        //ctx.statManager().createRateStat("tunnel.dispatchDataTime", "Time taken to dispatch a TunnelDataMessage", "Tunnels", RATES);
        //ctx.statManager().createRateStat("tunnel.dispatchOutboundTime", "Time taken to dispatch an outbound message", "Tunnels", RATES);
        //ctx.statManager().createRateStat("tunnel.dispatchOutboundZeroHopTime", "Time taken to dispatch an outbound message through a zero hop tunnel", "Tunnels", RATES);
