...
public enum SigType {
    ...
    static {
        ...
        for (SigType type : values) {
            int i = type.getCode();
            if (BY_CODE[i] != null) throw new IllegalStateException("Duplicate SigType code");
            BY_CODE[i] = type;
        }
    }
    ...
    public static SigType parseSigType(String stype) {
        try {
            ...
            if (uc.equals("EDDSA_SHA512_ED25519")) return EdDSA_SHA512_Ed25519;
            if (uc.equals("EDDSA_SHA512_ED25519PH")) return EdDSA_SHA512_Ed25519ph;
            if (uc.equals("REDDSA_SHA512_ED25519")) return RedDSA_SHA512_Ed25519;
            return valueOf(uc);
