...
public class messages_et extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} tund", "{0} tundi" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} sarnase s\u00f5numi m\u00e4\u00e4ramata j\u00e4etud", "{0} sarnast s\u00f5numit m\u00e4\u00e4ramata j\u00e4etud" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} s", "{0} s" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} p\u00e4ev", "{0} p\u00e4eva" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} aasta", "{0} aastat" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
