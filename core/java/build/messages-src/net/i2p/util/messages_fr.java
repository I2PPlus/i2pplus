...
public class messages_fr extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} heure", "{0} heures" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} message similaire omis", "{0} messages similaires omis" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} s", "{0} s" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} jour", "{0} jours" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} an", "{0} ans" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
    t[45] = new java.lang.String[] { "{0,number,####} ms", "{0,number,###} ms" };
    table = t;
  }
