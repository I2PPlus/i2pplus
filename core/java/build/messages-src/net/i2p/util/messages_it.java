...
public class messages_it extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} ora", "{0} ore" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} messaggio simile omesso", "{0} messaggi simili omessi" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} sec", "{0} sec" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} giorno", "{0} giorni" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} anno", "{0} anni" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
