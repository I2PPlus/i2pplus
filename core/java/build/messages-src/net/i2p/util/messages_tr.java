...
public class messages_tr extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[9] = new java.lang.String[] { "{0} benzer ileti yok say\u0131ld\u0131", "{0} benzer ileti yok say\u0131ld\u0131" };
    t[10] = "DEBUG";
    t[11] = "AYIKLA";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} sn", "{0} sn" };
    t[14] = "{0} day";
    ...
    t[19] = "AC\u0130L";
    t[20] = "{0} min";
    t[21] = new java.lang.String[] { "{0} dk", "{0} dk" };
    t[22] = "WARN";
    t[23] = "UYARI";
    t[28] = "ERROR";
    t[29] = "HATA";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} y\u0131l", "{0} y\u0131l" };
    t[40] = "INFO";
    t[41] = "B\u0130LG\u0130";
    t[44] = "{0,number,####} \u03bcs";
