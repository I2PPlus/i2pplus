...
public class messages_fi extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} tunti", "{0} tuntia" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} samankaltainen viesti j\u00e4tetty pois", "{0} samankaltaista viesti\u00e4 j\u00e4tetty pois" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} s", "{0} s" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} p\u00e4iv\u00e4", "{0} p\u00e4iv\u00e4\u00e4" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} vuosi", "{0} vuotta" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
