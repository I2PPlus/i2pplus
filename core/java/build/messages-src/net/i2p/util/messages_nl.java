...
public class messages_nl extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} uur", "{0} uur" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} soortgelijk bericht weggelaten", "{0} soortgelijke berichten weggelaten" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} s", "{0} s" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} dag", "{0} dagen" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} jaar", "{0} jaar" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
