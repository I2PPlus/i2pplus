...
public class messages_es extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} hora", "{0} horas" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} mensaje similar omitido", "{0} mensajes similares omitidos" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} s", "{0} s" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} d\u00eda", "{0} d\u00edas" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} a\u00f1o", "{0} a\u00f1os" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
