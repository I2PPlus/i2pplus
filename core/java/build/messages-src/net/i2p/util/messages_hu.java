...
public class messages_hu extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} \u00f3ra", "{0} \u00f3r\u00e1k" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} hasonl\u00f3 \u00fczenet elhagyva", "{0} hasonl\u00f3 \u00fczenet elhagyva" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} mp", "{0} mperc" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} nap", "{0} napok" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} \u00e9v", "{0} \u00e9vek" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
