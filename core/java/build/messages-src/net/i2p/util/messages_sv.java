...
public class messages_sv extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} timme", "{0} timmar" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} liknande meddelande utel\u00e4mnat", "{0} liknande meddelanden utel\u00e4mnade" };
    t[10] = "DEBUG";
    t[11] = "FELS\u00d6K";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} sek", "{0} sek" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} dag", "{0} dagar" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} \u00e5r", "{0} \u00e5r" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
