...
public class messages_az extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} saat", "{0} saat" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} ox\u015far mesaj \u00f6t\u00fcr\u00fcld\u00fc", "{0} ox\u015far mesaj \u00f6t\u00fcr\u00fcld\u00fc" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} saniy\u0259", "{0} saniy\u0259" };
    t[14] = "{0} day";
    ...
    t[19] = "KR\u0130T";
    t[20] = "{0} min";
    t[21] = new java.lang.String[] { "{0} d\u0259qiq\u0259", "{0} d\u0259qiq\u0259" };
    t[22] = "WARN";
    t[23] = "WARN";
    t[28] = "ERROR";
    t[29] = "ERROR";
    ...
    t[31] = "yok";
    t[32] = "{0,number,####} ns";
    t[33] = new java.lang.String[] { "{0,number,####} n\u00f6n\u0259sec", "{0,number,####} n\u00f6n\u0259sec" };
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} il", "{0} il" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
