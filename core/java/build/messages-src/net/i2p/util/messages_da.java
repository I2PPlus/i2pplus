...
public class messages_da extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} time", "{0} timer" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} lignende besked udeladt", "{0} lignende meddelelser udeladt" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} sek", "{0} sek" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} dag", "{0} dage" };
    t[16] = "{0,number,####} ms";
    ...
    t[29] = "ERROR";
    t[30] = "n/a";
    t[31] = "Ikke ting\u00e6ngelig ";
    t[32] = "{0,number,####} ns";
    t[33] = new java.lang.String[] { "{0,number,####} ms", "{0,number,####} ms" };
    t[34] = "{0} year";
