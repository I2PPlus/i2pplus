...
public class messages_vi extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[4] = "{0} hour";
    t[5] = new java.lang.String[] { "{0} gi\u1edd" };
    t[8] = "{0} similar message omitted";
    t[9] = new java.lang.String[] { "{0} C\u00e1c tin nh\u1eafn t\u01b0\u01a1ng t\u1ef1 b\u1ecb b\u1ecf qua" };
    t[10] = "DEBUG";
    t[11] = "DEBUG";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} gi\u00e2y" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} ng\u00e0y" };
    t[16] = "{0,number,####} ms";
    t[17] = new java.lang.String[] { "{0,number,####} mili gi\u00e2y" };
    t[18] = "CRIT";
    t[19] = "CRIT";
    t[20] = "{0} min";
    t[21] = new java.lang.String[] { "{0} ph\u00fat" };
    t[22] = "WARN";
    t[23] = "WARN";
    t[28] = "ERROR";
    t[29] = "L\u1ed6I";
    ...
    t[31] = "ch\u01b0a r\u00f5";
    t[32] = "{0,number,####} ns";
    t[33] = new java.lang.String[] { "{0,number,####} nano gi\u00e2y" };
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "{0} n\u0103m" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
    t[45] = new java.lang.String[] { "{0,number,###} micro gi\u00e2y" };
    table = t;
  }
