...
public class messages_nb extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[9] = new java.lang.String[] { "{0} lignende melding utelatt", "{0} lignende meldinger utelatt" };
    t[10] = "DEBUG";
    t[11] = "FEILRETTING";
    t[12] = "{0} sec";
    t[13] = new java.lang.String[] { "{0} sek", "{0} sek" };
    t[14] = "{0} day";
    t[15] = new java.lang.String[] { "{0} dag", "{0} dager" };
    t[16] = "{0,number,####} ms";
    ...
    t[34] = "{0} year";
    t[35] = new java.lang.String[] { "ett \u00e5r", "{0} \u00e5r" };
    t[40] = "INFO";
    t[41] = "INFO";
    t[44] = "{0,number,####} \u03bcs";
