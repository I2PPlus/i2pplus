...
void readOptions(char*** options, int* size) {
	...
	if(file == NULL) {
		...
		*options = (char**)MemAlloc(sizeof(char*) * (*size));
		...
		(*options)[i++] = "-cp";
		(*options)[i++] = "lib/i2p.jar;lib/router.jar;lib/jbigi.jar;lib/sam.jar;lib/mstreaming.jar;lib/streaming.jar;lib/routerconsole.jar;lib/i2ptunnel.jar;lib/org.mortbay.jetty.jar;lib/javax.servlet.jar;lib/jasper-runtime.jar;lib/commons-el.jar;lib/wrapper.jar;lib/systray.jar;lib/desktopgui.jar;lib/i2psnark.jar;lib/jrobin.jar;lib/jstl.jar;lib/standard.jar;lib/jetty-continuation.jar;lib/jetty-deploy.jar;lib/jetty-http.jar;lib/jetty-i2p.jar;lib/jetty-io.jar;lib/jetty-rewrite-handler.jar;lib/jetty-security.jar;lib/jetty-servlet.jar;lib/jetty-servlets.jar;lib/jetty-start.jar;lib/jetty-util.jar;lib/jetty-webapp.jar;lib/jetty-xml.jar;lib/pack200.jar";
