...
- `i2prouter` - Main router startup script (template)
- `i2prouter.service` - Systemd service unit (template)
- `install_i2p_service_unix` - Unix service installer
- `runplain.sh` - Plain Java launcher (no wrapper)
