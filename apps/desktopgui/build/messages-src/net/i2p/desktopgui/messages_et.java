...
public class messages_et extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[5] = "V\u00e4ljal\u00fclitamine l\u00e4henemisel";
    t[6] = "Shutdown in {0}";
    t[7] = "V\u00e4ljal\u00fclitamine {0} p\u00e4rast";
    t[10] = "Network";
    t[11] = "V\u00f5rk";
    t[16] = "Enable notifications";
    t[17] = "Luba teatised";
    t[18] = "Configure I2P System Tray";
    t[19] = "Seadista I2P s\u00fcsteemiriba";
    t[22] = "Stop I2P";
    t[23] = "Peata I2P";
    t[24] = "I2P: Right-click for menu";
    t[25] = "I2P: Kl\u00f5psake paremale nupule men\u00fc\u00fc jaoks";
    t[28] = "Restart I2P Immediately";
    t[29] = "Taask\u00e4ivita I2P kohe";
    t[30] = "Stop I2P Immediately";
    t[31] = "Peata I2P kohe";
    t[50] = "Restart I2P";
    t[51] = "Taask\u00e4ivita I2P";
    t[54] = "Starting";
    t[55] = "K\u00e4ivitamine";
    t[64] = "Disable system tray";
    t[65] = "Keela s\u00fcsteemiriba";
    t[70] = "Cancel I2P Shutdown";
    t[71] = "T\u00fchista I2P katkemine";
    t[74] = "Disable notifications";
    t[75] = "Keela teatised";
    t[86] = "I2P is starting!";
    t[87] = "I2P k\u00e4ivitatakse!";
    t[88] = "Start I2P";
    t[89] = "Aloita I2P";
    t[100] = "Launch I2P Browser";
    t[101] = "Lanceeri I2P veebibrauser";
    table = t;
  }
