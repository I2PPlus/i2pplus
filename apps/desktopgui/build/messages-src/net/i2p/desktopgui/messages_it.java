...
public class messages_it extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[5] = "Arresto imminente";
    t[6] = "Shutdown in {0}";
    t[7] = "Arresto in {0}";
    t[10] = "Network";
    t[11] = "Rete";
    t[16] = "Enable notifications";
    t[17] = "Attivare le notifiche";
    t[18] = "Configure I2P System Tray";
    t[19] = "Configura icona di I2P nella Barra di notifica";
    t[22] = "Stop I2P";
    t[23] = "Arresta I2P";
    t[24] = "I2P: Right-click for menu";
    t[25] = "I2P: Fai click destro per aprire il menu";
    t[28] = "Restart I2P Immediately";
    t[29] = "Riavvia subito I2P";
    t[30] = "Stop I2P Immediately";
    t[31] = "Arresta subito I2P";
    t[50] = "Restart I2P";
    t[51] = "Riavvia I2P";
    t[54] = "Starting";
    t[55] = "Avvio in corso";
    t[64] = "Disable system tray";
    t[65] = "Disabilita il vassoio di sistema";
    t[70] = "Cancel I2P Shutdown";
    t[71] = "Annulla arresto di I2P";
    t[74] = "Disable notifications";
    t[75] = "Disabilita le notifiche";
    t[86] = "I2P is starting!";
    t[87] = "Avvio di I2P in corso!";
    t[88] = "Start I2P";
    t[89] = "Avvia I2P";
    t[100] = "Launch I2P Browser";
    t[101] = "Lancia il browser I2P";
    table = t;
  }
