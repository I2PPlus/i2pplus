...
public class messages_nl extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[5] = "Wordt zo meteen afgesloten";
    t[6] = "Shutdown in {0}";
    t[7] = "Afsluiten over {0}";
    t[10] = "Network";
    t[11] = "Netwerk";
    t[16] = "Enable notifications";
    t[17] = "Notificaties aanzetten";
    t[18] = "Configure I2P System Tray";
    t[19] = "I2P-systeemvak configureren";
    t[22] = "Stop I2P";
    t[23] = "I2P stoppen";
    t[24] = "I2P: Right-click for menu";
    t[25] = "I2P: rechterklik voor menu";
    t[28] = "Restart I2P Immediately";
    t[29] = "I2P onmiddellijk herstarten";
    t[30] = "Stop I2P Immediately";
    t[31] = "I2P onmiddellijk stoppen";
    t[50] = "Restart I2P";
    t[51] = "I2P herstarten";
    t[54] = "Starting";
    t[55] = "Bezig met starten";
    t[64] = "Disable system tray";
    t[65] = "Schakel het systeemvak uit";
    t[70] = "Cancel I2P Shutdown";
    t[71] = "Afsluiten I2P annuleren";
    t[74] = "Disable notifications";
    t[75] = "Meldingen uitschakelen";
    t[86] = "I2P is starting!";
    t[87] = "I2P is aan het starten!";
    t[88] = "Start I2P";
    t[89] = "I2P starten";
    t[100] = "Launch I2P Browser";
    t[101] = "I2P-browser starten";
    table = t;
  }
