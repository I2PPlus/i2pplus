...
public class messages_in extends java.util.ResourceBundle {
  ...
  static {
    ...
    t[5] = "I2P sedang dalam proses dimatikan";
    t[6] = "Shutdown in {0}";
    t[7] = "Mematikan I2P dalam {0}";
    t[10] = "Network";
    t[11] = "Jaringan";
    t[16] = "Enable notifications";
    t[17] = "Aktifkan pemberitahuan";
    t[18] = "Configure I2P System Tray";
    t[19] = "Ubah pengaturan I2P System Tray";
    t[22] = "Stop I2P";
    t[23] = "Hentikan I2P";
    t[24] = "I2P: Right-click for menu";
    t[25] = "I2P: klik kanan untuk menampilkan menu";
    t[28] = "Restart I2P Immediately";
    t[29] = "Ulang kembali I2P sekarang";
    t[30] = "Stop I2P Immediately";
    t[31] = "Hentikan I2P sekarang";
    t[50] = "Restart I2P";
    t[51] = "Mulai ulang I2P";
    t[54] = "Starting";
    t[55] = "Memulai";
    t[64] = "Disable system tray";
    t[65] = "Nonaktifkan baki sistem";
    t[70] = "Cancel I2P Shutdown";
    t[71] = "Batal tutup I2P";
    t[74] = "Disable notifications";
    t[75] = "Nonaktifkan pemberitahuan";
    t[86] = "I2P is starting!";
    t[87] = "I2P sudah memulai!";
    t[88] = "Start I2P";
    t[89] = "Mulai I2P";
    t[100] = "Launch I2P Browser";
    t[101] = "Luncurkan Peramban I2P";
    table = t;
  }
