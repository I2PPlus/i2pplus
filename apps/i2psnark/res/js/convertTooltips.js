...
(() => {
  ...
  styleElement.innerHTML =
    ...
    '.barTooltip::before{padding:5px 10px;position:absolute;bottom:120%;z-index:999;line-height:1.3;white-space:pre;font-size:90%;color:#fff;border-radius:4px;background:var(--tooltip);transform:translateX(-50%);content:attr(data-tooltip)}' +
    ...
    '.barTooltip:hover::before,.barTooltip:hover::after{opacity:1}' +
