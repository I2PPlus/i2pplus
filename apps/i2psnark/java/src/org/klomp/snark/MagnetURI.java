...
public class MagnetURI {
    ...
    /**
     * Decode %xx encoding, convert to UTF-8 if necessary. Copied from i2ptunnel LocalHTTPServer.
     * Also converts '+' to ' ' so the dn parameter comes out right These are coming in via a
     * application/x-www-form-urlencoded form so the pluses are in there... hopefully any real + is
     * encoded as %2B.
     *
     * @since 0.9.1
     */
