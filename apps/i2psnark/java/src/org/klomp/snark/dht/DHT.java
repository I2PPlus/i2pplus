...
public interface DHT {
    ...
    /**
     * Announce to the closest DHT peers. Blocking unless maxWait &lt;= 0 Caller should run in a
     * thread. This also automatically announces ourself to our local tracker. For best results do a
