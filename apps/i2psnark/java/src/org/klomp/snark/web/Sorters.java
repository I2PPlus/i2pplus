...
class Sorters {
    ...
    /**
     * Sort alphabetically in current locale, ignore case, ignore leading articles such as "the" if
     * the pattern is set by setPattern()
     *
     * @since 0.7.14
     */
        ...
        private static int getStatusImpl(Snark snark) {
            ...
            if (downBps > 0) {
                ...
                if (activePeers > 0) {
                    ...
                    return STATUS_SEEDING_INACTIVE;
                } else {
