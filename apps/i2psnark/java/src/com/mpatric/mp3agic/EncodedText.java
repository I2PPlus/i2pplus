...
public class EncodedText {
    ...
    private static final String[] characterSets = {
        CHARSET_ISO_8859_1, CHARSET_UTF_16, CHARSET_UTF_16BE, CHARSET_UTF_8
    };
    ...
    /**
     * Constructs an EncodedText with the specified text encoding and byte value.
     * Automatically detects UTF-16BE from BOM and strips BOM and terminators.
     *
     * @param textEncoding the text encoding to use
     * @param value the byte array containing the encoded text
     */
    ...
    /**
     * Constructs an EncodedText from the specified string.
     * Tries different text encodings until one successfully encodes the string.
     *
     * @param string the string to encode
     * @throws IllegalArgumentException if the string cannot be encoded with any supported encoding
     */
    ...
    private void stripBomAndTerminator() {
        ...
        if (value.length >= 2
                && ((value[0] == (byte) 0xfe && value[1] == (byte) 0xff)
    ...
    /**
     * Returns the text encoding used for this encoded text.
     *
     * @return the text encoding constant
     */
    ...
    /**
     * Sets the text encoding and transcodes the text to the new encoding.
     *
    ...
    public void setTextEncoding(byte textEncoding, boolean transcode)
        ...
        if (this.textEncoding != textEncoding) {
            CharBuffer charBuffer =
                    bytesToCharBuffer(this.value, characterSetForTextEncoding(this.textEncoding));
    ...
    /**
     * Returns the terminator bytes for the current text encoding.
     *
     * @return the terminator bytes
     */
    ...
    /**
     * Returns the encoded text as a byte array without BOM or terminator.
     *
    ...
    /**
     * Returns the encoded text as a byte array with optional BOM.
     *
     * @param includeBom whether to include BOM for UTF-16 encodings
     * @return the encoded text as bytes
     */
    ...
    /**
     * Returns the encoded text as a byte array with optional BOM and terminator.
     *
     * @param includeBom whether to include BOM for UTF-16 encodings
     * @param includeTerminator whether to include terminator bytes
     * @return the encoded text as bytes
     */
    public byte[] toBytes(boolean includeBom, boolean includeTerminator) {
        ...
        int newLength =
                value.length
                        + (includeBom ? boms[textEncoding].length : 0)
    ...
    /**
     * Returns the decoded string representation of this encoded text.
     *
    ...
    /**
     * Returns the character set name for the current text encoding.
     *
    ...
    private static String bytesToString(byte[] bytes, String characterSet)
            throws CharacterCodingException {
    ...
    protected static CharBuffer bytesToCharBuffer(byte[] bytes, String characterSet)
            throws CharacterCodingException {
