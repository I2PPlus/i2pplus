...
public abstract class AbstractID3v2Tag implements ID3v2 {
     ...
     * @throws InvalidDataException if the tag data is invalid
     */
    public AbstractID3v2Tag(byte[] bytes, boolean obseleteFormat)
            throws NoSuchTagException, UnsupportedTagException, InvalidDataException {
        frameSets = new TreeMap<>();
    ...
    private int packExtendedHeader(byte[] bytes, int offset) {
        ...
        BufferTools.copyIntoByteBuffer(
                extendedHeaderData, 0, extendedHeaderData.length, bytes, offset + 4);
            ...
            if ((onlyId == null || onlyId.equals(frameSet.getId()))
                ...
                for (ID3v2Frame frame : frameSet.getFrames()) {
                    if (frame.getDataLength() > 0) {
                        ...
                        BufferTools.copyIntoByteBuffer(
                                frameData, 0, frameData.length, bytes, offset);
    ...
    public String getTrack() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_TRACK_OBSELETE : ID_TRACK);
    ...
    public void setTrack(String track) {
        if (track != null && track.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(track));
    ...
    public String getPartOfSet() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_PART_OF_SET_OBSELETE : ID_PART_OF_SET);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setPartOfSet(String partOfSet) {
        if (partOfSet != null && partOfSet.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(partOfSet));
    ...
    public boolean isCompilation() {
        ...
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_COMPILATION_OBSELETE : ID_COMPILATION);
    ...
    public void setCompilation(boolean compilation) {
        ...
        ID3v2TextFrameData frameData =
                new ID3v2TextFrameData(
                        useFrameUnsynchronisation(), new EncodedText(compilation ? "1" : "0"));
    ...
    public String getGrouping() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_GROUPING_OBSELETE : ID_GROUPING);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setGrouping(String grouping) {
        if (grouping != null && grouping.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(grouping));
    ...
    public String getArtist() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_ARTIST_OBSELETE : ID_ARTIST);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setArtist(String artist) {
        if (artist != null && artist.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(artist));
    ...
    public String getAlbumArtist() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_ALBUM_ARTIST_OBSELETE : ID_ALBUM_ARTIST);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setAlbumArtist(String albumArtist) {
        if (albumArtist != null && albumArtist.length() > 0) {
            ...
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(
                            useFrameUnsynchronisation(), new EncodedText(albumArtist));
    ...
    public String getTitle() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_TITLE_OBSELETE : ID_TITLE);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setTitle(String title) {
        if (title != null && title.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(title));
    ...
    public String getAlbum() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_ALBUM_OBSELETE : ID_ALBUM);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setAlbum(String album) {
        if (album != null && album.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(album));
    ...
    public String getYear() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_YEAR_OBSELETE : ID_YEAR);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setYear(String year) {
        if (year != null && year.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(year));
    ...
    public String getDate() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_DATE_OBSELETE : ID_DATE);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setDate(String date) {
        if (date != null && date.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(date));
    ...
    public int getGenre() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_GENRE_OBSELETE : ID_GENRE);
        if (frameData == null || frameData.getText() == null) {
            return -1;
        }
    ...
    public void setGenre(int genre) {
        if (genre >= 0) {
            ...
            String genreDescription =
                    genre < ID3v1Genres.GENRES.length ? ID3v1Genres.GENRES[genre] : "";
            String combinedGenre = "(" + Integer.toString(genre) + ")" + genreDescription;
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(
                            useFrameUnsynchronisation(), new EncodedText(combinedGenre));
    ...
    public int getBPM() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_BPM_OBSELETE : ID_BPM);
        if (frameData == null || frameData.getText() == null) {
            return -1;
        }
    ...
    public void setBPM(int bpm) {
        if (bpm >= 0) {
            ...
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(
                            useFrameUnsynchronisation(), new EncodedText(Integer.toString(bpm)));
    ...
    public String getKey() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_KEY_OBSELETE : ID_KEY);
        if (frameData == null || frameData.getText() == null) {
            return null;
        }
    ...
    public void setKey(String key) {
        if (key != null && key.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(key));
    ...
    public String getComment() {
        ID3v2CommentFrameData frameData =
                extractCommentFrameData(obseleteFormat ? ID_COMMENT_OBSELETE : ID_COMMENT, false);
    ...
    public void setComment(String comment) {
        if (comment != null && comment.length() > 0) {
            invalidateDataLength();
            ID3v2CommentFrameData frameData =
                    new ID3v2CommentFrameData(
                            useFrameUnsynchronisation(), "eng", null, new EncodedText(comment));
    ...
    public String getItunesComment() {
        ID3v2CommentFrameData frameData =
                extractCommentFrameData(obseleteFormat ? ID_COMMENT_OBSELETE : ID_COMMENT, true);
        if (frameData != null && frameData.getComment() != null)
            return frameData.getComment().toString();
        return null;
    }
        ...
        if (itunesComment != null && itunesComment.length() > 0) {
            ...
            ID3v2CommentFrameData frameData =
                    new ID3v2CommentFrameData(
                            ...
                            "eng",
                            new EncodedText(ITUNES_COMMENT_DESCRIPTION),
                            new EncodedText(itunesComment));
            addFrame(createFrame(ID_COMMENT, frameData.toBytes()), true);
        }
    }
    ...
    protected ID3v2CommentFrameData extractLyricsFrameData(String id) {
        ...
        if (frameSet != null) {
            for (ID3v2Frame frame : frameSet.getFrames()) {
                ...
                try {
                    frameData =
                            new ID3v2CommentFrameData(useFrameUnsynchronisation(), frame.getData());
                    return frameData;
                } catch (InvalidDataException e) {
                    // Do nothing
                }
    ...
    public String getLyrics() {
        ...
        if (frameData != null) return frameData.getComment().toString();
    ...
    public void setLyrics(String lyrics) {
        if (lyrics != null && lyrics.length() > 0) {
            ...
            ID3v2CommentFrameData frameData =
                    new ID3v2CommentFrameData(
                            useFrameUnsynchronisation(), "eng", null, new EncodedText(lyrics));
    ...
    public void setComposer(String composer) {
        if (composer != null && composer.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(composer));
    ...
    public String getPublisher() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_PUBLISHER_OBSELETE : ID_PUBLISHER);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setPublisher(String publisher) {
        if (publisher != null && publisher.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(publisher));
    ...
    public String getOriginalArtist() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(
                        obseleteFormat ? ID_ORIGINAL_ARTIST_OBSELETE : ID_ORIGINAL_ARTIST);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setOriginalArtist(String originalArtist) {
        if (originalArtist != null && originalArtist.length() > 0) {
            ...
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(
                            useFrameUnsynchronisation(), new EncodedText(originalArtist));
    ...
    public String getCopyright() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_COPYRIGHT_OBSELETE : ID_COPYRIGHT);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setCopyright(String copyright) {
        if (copyright != null && copyright.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(copyright));
    ...
    public String getUrl() {
        ID3v2UrlFrameData frameData =
                extractUrlFrameData(obseleteFormat ? ID_URL_OBSELETE : ID_URL);
        if (frameData != null) return frameData.getUrl();
        return null;
    }
    ...
    public void setUrl(String url) {
        if (url != null && url.length() > 0) {
            invalidateDataLength();
            ID3v2UrlFrameData frameData =
                    new ID3v2UrlFrameData(useFrameUnsynchronisation(), null, url);
    ...
    public String getEncoder() {
        ID3v2TextFrameData frameData =
                extractTextFrameData(obseleteFormat ? ID_ENCODER_OBSELETE : ID_ENCODER);
        if (frameData != null && frameData.getText() != null) return frameData.getText().toString();
        return null;
    }
    ...
    public void setEncoder(String encoder) {
        if (encoder != null && encoder.length() > 0) {
            invalidateDataLength();
            ID3v2TextFrameData frameData =
                    new ID3v2TextFrameData(useFrameUnsynchronisation(), new EncodedText(encoder));
    ...
    public byte[] getAlbumImage() {
        ID3v2PictureFrameData frameData =
                createPictureFrameData(obseleteFormat ? ID_IMAGE_OBSELETE : ID_IMAGE);
    ...
    public void setAlbumImage(
            byte[] albumImage, String mimeType, byte imageType, String imageDescription) {
        if (albumImage != null
                && albumImage.length > 0
                && mimeType != null
                && mimeType.length() > 0) {
    ...
    public void setWmpRating(final int rating) {
        if (rating >= 0 && rating < 6) {
            invalidateDataLength();
            final ID3v2PopmFrameData frameData =
                    new ID3v2PopmFrameData(useFrameUnsynchronisation(), rating);
    ...
    private ArrayList<ID3v2ChapterFrameData> extractChapterFrameData(String id) {
        ...
        if (frameSet != null) {
            ...
            for (ID3v2Frame frame : frames) {
                ...
                try {
                    frameData =
                            new ID3v2ChapterFrameData(useFrameUnsynchronisation(), frame.getData());
    ...
    private ArrayList<ID3v2ChapterTOCFrameData> extractChapterTOCFrameData(String id) {
        ...
        if (frameSet != null) {
            ...
            for (ID3v2Frame frame : frames) {
                ...
                try {
                    frameData =
                            new ID3v2ChapterTOCFrameData(
                                    useFrameUnsynchronisation(), frame.getData());
                    chapterData.add(frameData);
                } catch (InvalidDataException e) {
                    // do nothing
                }
            ...
            for (ID3v2Frame frame : frameSet.getFrames()) {
                ...
                try {
                    frameData =
                            new ID3v2CommentFrameData(useFrameUnsynchronisation(), frame.getData());
                    if (itunes
                            && ITUNES_COMMENT_DESCRIPTION.equals(
                                    frameData.getDescription().toString())) {
                        return frameData;
                    } else if (!itunes) {
                        return frameData;
                    }
    ...
    private ID3v2PictureFrameData createPictureFrameData(String id) {
        ...
        if (frameSet != null) {
            ...
            try {
                if (obseleteFormat)
                    frameData =
                            new ID3v2ObseletePictureFrameData(
                                    useFrameUnsynchronisation(), frame.getData());
                else
                    frameData =
                            new ID3v2PictureFrameData(useFrameUnsynchronisation(), frame.getData());
                return frameData;
            } catch (InvalidDataException e) {
                // do nothing
            }
