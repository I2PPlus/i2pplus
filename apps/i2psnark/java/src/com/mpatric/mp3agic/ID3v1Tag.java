...
public class ID3v1Tag implements ID3v1 {
    ...
    /**
     * Constructs a new empty ID3v1Tag.
     */
    public ID3v1Tag() {}

    /**
     * Constructs an ID3v1Tag from the specified byte array.
     *
     * @param bytes the byte array containing the ID3v1 tag data
     * @throws NoSuchTagException if no valid ID3v1 tag is found in the data
     */
    ...
    private void sanityCheckTag(byte[] bytes) throws NoSuchTagException {
        ...
        if (!TAG.equals(
                BufferTools.byteBufferToStringIgnoringEncodingIssues(bytes, 0, TAG.length()))) {
    ...
    /**
     * Packs the ID3v1 tag data into the specified byte array.
     * The byte array must be at least 128 bytes long.
     *
     * @param bytes the byte array to pack the tag data into
     */
