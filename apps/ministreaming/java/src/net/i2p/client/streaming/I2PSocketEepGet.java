    ...
    protected void sendRequest(SocketTimeout timeout) throws IOException {
        ...
        try {
            ...
            if ("http".equals(url.getScheme())) {
                ...
                props.setProperty(I2PSocketOptions.PROP_CONNECT_TIMEOUT, Integer.toString(DEFAULT_CONNECT_TIMEOUT));
                props.setProperty(I2PSocketOptions.PROP_READ_TIMEOUT, Integer.toString(DEFAULT_INACTIVITY_TIMEOUT));
