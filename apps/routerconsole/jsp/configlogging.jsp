...
<td><label><input type="checkbox slider" class=optbox name="logcompress" value=true <jsp:getProperty name="logginghelper" property="logCompress" /> > Compress logs</label></td>
<td></td>
</tr>
<%
   }
