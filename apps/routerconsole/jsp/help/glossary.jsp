...
<title><%=intl._t("Glossary")%> - I2P+</title>
</head>
<body>
...
<span class="tab2"><%=intl._t("Glossary")%></span>
...
<p><b><%=intl._t("Base32 (B32) / Base64 (B64)")%><br>
...
<p><b><%=intl._t("Exploratory Tunnel")%><br>
...
<p><b><%=intl._t("Network Database")%><br>
...
<p><b><%=intl._t("Router Identity")%><br>
...
<p><b><%=intl._t("Strict Countries")%><br>
...
<p><b><%=intl._t("Tunnel Endpoint")%><br>
