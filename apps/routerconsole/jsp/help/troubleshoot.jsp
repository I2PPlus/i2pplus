...
Where possible, please ensure I2P/Java is allowed bi-directional port access from the internet by configuring your modem/router/pc firewall accordingly. If you're behind a prohibitive firewall but have unrestricted outbound access, I2P can still function; you can turn off inbound access and rely on <a href="http://i2p-projekt.i2p/udp.html" target="_blank" class="sitelink">SSU IP Address Detection</a> (<a href="https://wikipedia.org/wiki/Hole_punching" target="_blank" class="sitelink external">firewall hole punching</a>) to connect you to the network, and your network status in the side panel will indicate "Network: Firewalled". For optimal performance, please ensure I2P's <a href="/confignet#udpconfig">external port</a> is visible from the internet (see below for more information).</li>

<li><b>Check Your Proxy Setttings</b><br>
If you cannot see any websites at all (not even <a href="http://i2p-projekt.i2p/" target="_blank">i2p-projekt.i2p</a>), make sure your browser's proxy is set to access http traffic (<i>not</i> https, <i>not</i> socks) via <code>127.0.0.1 port 4444</code>. If you need some help, there's <a href="https://geti2p.net/en/about/browser-config" target="_blank" class="sitelink external">a guide</a> to configuring your browser for I2P use.</li>

<li><b>Check Your Logs</b><br>
<a href="/logs">Logs</a> may help resolve a problem. You may wish to paste excerpts in a <a href="http://i2pforum.i2p/" target="_blank">forum</a> for help, or perhaps <a href="http://zerobin.i2p/" target="_blank" class="sitelink external">paste</a> it instead and reference the link on IRC for help.</li>
