...
<%=intl._t("To view all active bans by router hash, see {0}Banned Peers{1}.", "<a href=\"/profiles?show=banned\">", "</a>")%>&nbsp;
<%=intl._t("A list of {0}session-only bans{1} by hash is also available.", "<a href=\"/profiles?show=banned\">", "</a>")%>
</td></tr>
