...
<%
  LinkEntry[] infoLinks = new LinkEntry[]{
    ...
    new LinkEntry("/netdb?show=lookup", "Network database search tool", "/themes/console/images/searchnetdb.svg", "NetDb Search", false),
    new LinkEntry("/peers", "View active peers", "/themes/console/images/peers.svg", "Peers", false),
    new LinkEntry("/profiles?show=fast", "View peer performance profiles", "/themes/console/images/profile.svg", "Profiles", false),
    ...
    new LinkEntry("/netdb?show=sybils", "Review possible sybils in network database", "/themes/console/images/sybil.svg", "Sybil Analysis", false),
