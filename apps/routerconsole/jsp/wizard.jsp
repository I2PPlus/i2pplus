...
Select the language to be used for the router console and web applications (<a href="/webmail" target="_blank">webmail</a>, <a href="/torrents" target="_blank">torrents</a>, <a href="/tunnelmgr" target="_blank">tunnel manager</a> etc). If you wish to change the language in future, change the router console theme, or configure a password to access the console, you may do so on the <a href="/configui" target="_blank">User Interface configuration page</a>.
</p>
