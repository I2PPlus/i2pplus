...
<tr><th align="left" colspan="2" id=<%=statshelper.getCurrentGroupName()%>><b><%=statshelper.getCurrentGroupName()%></b></th></tr>
...
%>
<label for="<%=statshelper.getCurrentStatName()%>" data-tooltip="<%=statshelper.getCurrentStatDescription()%>"><div class="stattograph"><input type="checkbox" class="optbox <%=statshelper.getCurrentGroupName()%>" id="<%=statshelper.getCurrentStatName()%>" name="graphList" value="<%=statshelper.getCurrentGraphName()%>" <% if (statshelper.getCurrentIsGraphed()) {%>checked="checked"<%}%>><b><%=statshelper.getCurrentStatName()%></b><br><span class="statdesc"><%=statshelper.getCurrentStatDescription()%></span></div></label>
<%
