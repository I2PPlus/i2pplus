...
<table><tr><td><div><jsp:getProperty name="searchhelper" property="selector"/><input size=40 type=text class=search name=query required placeholder="<%=intl._t("Please enter a search query")%>"><button type=submit value="search" class=search><%=intl._t("Search")%></button></div></td></tr></table>
</form>
</div>
<div class=linkcontainer>
<h4 id=applinks><%=intl._t("Applications and Configuration").replace(" and ", " &amp; ")%>
<span class=headerlinks><a href=/confighome#configapps class=customizelinks style=float:right title="<%=intl._t("Customize links")%>"><%=intl._t("Customize links")%></a>
...
<a href=/config id=configbandwidth style=float:right title="<%=intl._t("Configure router bandwidth")%>"><img src="/themes/console/images/speedometer.svg" height=16 width=16 alt="<%=intl._t("Bandwidth")%>"></a>
<%  } %>
</span></h4>
<jsp:getProperty name="homehelper" property="services"/>
<br></div>
<div class=linkcontainer>
<h4 id=sitelinks><%=intl._t("Sites of Interest")%><span class=headerlinks><a href=/confighome#configsites class=customizelinks style=float:right title="<%=intl._t("Customize links")%>"><%=intl._t("Customize links")%></a></span></h4>
