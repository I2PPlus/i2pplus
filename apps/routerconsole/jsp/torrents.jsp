...
<iframe id=i2psnarkframe class=embed src="<%=requestURL%>" title="I2P+ <%=intl._t("Torrent Manager")%>" border=0 width=100% name="i2psnarkframe" allow=fullscreen allowfullscreen=true>
