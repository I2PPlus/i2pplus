...
//    private static final int MAX_LENGTH = 4;
    ...
    private void renderForm(StringBuilder buf, int index, String prefix, String name, TunnelPoolSettings in, TunnelPoolSettings out) {
        ...
        buf.append("<tr><th></th><th class=inbound>").append(_t("Inbound")).append("</th><th class=outbound>")
           .append(_t("Outbound")).append("</th><th class=spacer></th>\n</tr>\n");

        // tunnel depth
        int maxLength = advanced ? MAX_ADVANCED_LENGTH : MAX_LENGTH;
        buf.append("<tr><td><b>").append(_t("Length")).append(":</b></td>\n")
        ...
        if (advanced) {
            buf.append("<tr><td><b>").append(_t("Randomization")).append(":</b></td>\n")
        ...
        if (!props.isEmpty()) {
            buf.append("<tr><td><b>").append(_t("Inbound options")).append(":</b></td>\n")
        ...
        if (!props.isEmpty()) {
            buf.append("<tr><td><b>").append(_t("Outbound options")).append(":</b></td>\n")
               .append("<td colspan=2><input name=\"").append(index)
