...
class SidebarRenderer {
    ...
    public String renderHelpAndFAQHTML() {
        ...
        Map<String, String> svcs = new TreeMap<>(Collator.getInstance());
...
*/
    ...
    public String renderPeersHTML() {
        ...
        buf.append("</span></td></tr>\n<tr title=\"")
           ...
           .append("\"><td><a href=\"/profiles?show=fast\"><b>")
           .append(_t("Fast"))
           .append("</b></a></td><td class=digits><span class=volatile>")
           ...
           .append("\"><td><a href=\"/profiles?show=floodfill\"><b>")
           .append(_t("Floodfill"))
           .append("</b></a></td><td class=digits><span class=volatile>")
        ...
        if (_helper.getBanlistedPeers() > 1) {
            buf.append("<tr title=\"")
               ...
               .append("\"><td><a href=\"/profiles?show=banned\"><b>")
               .append(_t("Banned"))
               .append("</b></a></td><td class=digits><span class=volatile>")
        ...
        buf.append("<tr title=\"")
           ...
           .append("</span></td></tr>\n</table>\n<table id=sb_peers_condensed hidden>\n<tr><td><a class=sb_icon id=floodfill href=\"/profiles?show=floodfill\" title=\"")
           .append(_t("Floodfill"))
           .append("\"><span><span class=\"badge volatile\">")
           .append(_helper.getWellIntegratedPeers())
           .append("</span></span></a>\n<a class=sb_icon id=fast href=\"/profiles?show=fast\" title=\"")
           .append(_t("Fast"))
           .append("\"><span><span class=\"badge volatile\">")
           .append(_helper.getFastPeers())
           ...
           .append("\"><span><span class=\"badge volatile\">")
           .append(_helper.getUnreachablePeers())
           .append("</span></span></a>\n<a class=sb_icon id=banned href=\"/profiles?show=banned\" title=\"")
           .append(_t("Banned"))
           .append("\"><span><span class=\"badge volatile\">")
           .append(_helper.getBanlistedPeers())
           .append("</span></span></a>\n</td></tr>\n</table>\n");
