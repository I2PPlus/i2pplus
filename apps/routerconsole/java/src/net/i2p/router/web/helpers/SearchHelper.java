...
public class SearchHelper extends HelperBase {
    ...
    static final String ENGINES_DEFAULT =
            ...
            "ahmia.i2p" + S + "http://ahmia.i2p/search/?q=%s"
                    + S
                    + "i2pforum.i2p"
                    + S
                    + "http://i2pforum.i2p/search.php?keywords=%s"
                    + S
                    + "hackaday.i2p"
                    + S
                    + "http://hackaday.i2p/blog/?s=%s"
                    + S
                    + "isitup.i2p"
                    + S
                    + "http://isitup.i2p/api/check?sitename=%s"
                    + S
                    + "mojeek.i2p"
                    + S
                    + "http://mojeek.i2p/search?date=1&size=1&t=40&q=%s"
                    + S
                    + "newsnow.i2p"
                    + S
                    + "http://newsnow.i2p/?search=%s"
                    + S
                    + "notbob.i2p"
                    + S
                    + "http://notbob.i2p/cgi-bin/defcon.cgi?search=%s"
                    + S
                    + "pinterest"
                    + S
                    + "http://binternet.lostskunk-dnr.i2p/search.php?q=%s"
                    + S
                    + "psychonaut.i2p"
                    + S
                    + "http://psychonaut.i2p/w/index.php?search=%s&fulltext=Search"
                    + S
                    + "ramble.i2p"
                    + S
                    + "http://ramble.i2p/search?q=%s"
                    + S
                    + "slashdot.i2p"
                    + S
                    + "http://slashdot.i2p/index2.pl?fhfilter=%s"
                    + S
                    + "shinobi.i2p"
                    + S
                    + "http://shinobi.i2p/search?query=%s"
                    + S
                    + "shreddit.i2p/r/i2p"
                    + S
                    + "http://shreddit.i2p/r/i2p/search?q=%s&restrict_sr=on"
                    + S
                    + "teddit.i2p/r/i2p"
                    + S
                    + "http://teddit.i2p/r/i2p/search?q=%s&restrict_sr=on"
                    + S
                    + "tracker2.postman.i2p"
                    + S
                    + "http://tracker2.postman.i2p/?search=%s"
                    + S
                    + "tube.i2p"
                    + S
                    + "http://tube.i2p/search?query=%s"
                    + S
                    + "wiki.i2p-projekt.i2p"
                    + S
                    + "http://wiki.i2p-projekt.i2p/wiki/index.php?search=%s"
                    + S
                    + "wikiless.i2p"
                    + S
                    + "http://wikiless.i2p/w/index.php?search=%s&fulltext=Search"
                    + S
                    + "wordnik.i2p"
                    + S
                    + "http://wordnik.i2p/words?myWord=%s"
                    + "";
