        ...
        buf.append("<tr title=\"")
           ...
           .append("</span></td></tr>\n");
            ...
            buf.append("<table id=\"sb_tunnels_condensed\" class=\"volatile\" hidden>\n")
               .append("<tr><td>")
               .append("<a class=\"sb_icon\" id=\"service\" href=\"/profiles?f=1#profilelist\" title=\"").append(_t("Service"))
               .append("\"><span><span class=\"badge\">").append(_helper.getInboundClientTunnels() + _helper.getOutboundClientTunnels())
               .append("</span></span></a>\n")
               .append("<a class=\"sb_icon\" id=\"transit\" href=\"/tunnelsparticipating\" title=\"").append(_t("Transit"))
               .append("\"><span><span class=\"badge\">").append(partTunnels).append("</span></span></a>\n")
               .append("<a class=\"sb_icon\" id=\"utility\" href=\"/tunnels#exploratory\" title=\"").append(_t("Utility"))
