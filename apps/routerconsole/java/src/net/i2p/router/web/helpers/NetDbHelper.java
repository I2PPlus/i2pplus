...
public class NetDbHelper extends FormHandler {
    ...
    public void setRouter(String r) {
        if (r != null && r.length() > 0) {
            _routerPrefix = DataHelper.stripHTML(r.trim());
        } // XSS
    }
    ...
    public void setVersion(String v) {
        if (v != null && v.length() > 0) {
            _version = DataHelper.stripHTML(v.trim());
        } // XSS
    }
    ...
    public void setCountry(String c) {
        if (c != null && c.length() > 0) {
            _country = DataHelper.stripHTML(c.trim());
        } // XSS
    }
    ...
    public void setFamily(String c) {
        if (c != null && c.length() > 0) {
            _family = DataHelper.stripHTML(c.trim());
        } // XSS
    }
    ...
    public void setCaps(String c) {
        if (c != null && c.length() > 0) {
            _caps = DataHelper.stripHTML(c.trim());
        } // XSS
    }
    ...
    public void setIp(String c) {
        if (c != null && c.length() > 0) {
            _ip = DataHelper.stripHTML(c.trim());
        } // XSS
    }
    ...
    public void setSybil(String c) {
        if (c != null) {
            _sybil = DataHelper.stripHTML(c.trim());
        } // XSS
    }
    ...
    public void setMtu(String f) {
        if (f != null && f.length() > 0) {
            _mtu = DataHelper.stripHTML(f.trim());
        } // XSS
    }
    ...
    public void setSsucaps(String f) {
        if (f != null && f.length() > 0) {
            _ssucaps = DataHelper.stripHTML(f.trim());
        } // XSS
    }
    ...
    protected void processForm() {
        ...
        if ("Save".equals(_action)) {
            try {
                ...
                addFormError(_t("Bad value supplied, please check and try again."), true);
            }
        }
    }
    ...
    public String getNetDbSummary() {
        ...
        boolean isSearchResult = _routerPrefix != null || _version != null || _country != null || _family != null || _caps != null || _ip != null || _sybil != null || _port != 0 || _type != null || _mtu != null || _ipv6 != null || _ssucaps != null || _transport != null || _cost != 0 || _etype != null || _icount > 0;
        boolean renderCompactSearch = isSearchResult || getTab() == 0;
        // try {renderNavBar();}
        // catch (IOException ignore) {}
        try {
            if (renderCompactSearch) {
                renderCompactLookupForm();
            }
            if (isSearchResult) {
                renderer.renderRouterInfoHTML(_out, _limit, _page, _routerPrefix, _version, _country, _family, _caps, _ip, _sybil, _port, _highPort, _type, _etype, _mtu, _ipv6, _ssucaps, _transport, _cost, _icount);
            } else if (_lease) {
    ...
    private int getTab() {
        ...
        if (_routerPrefix != null || _version != null || _country != null || _family != null || _caps != null || _ip != null || _sybil != null || _port != 0 || _type != null || _mtu != null || _ipv6 != null || _ssucaps != null || _transport != null || _cost != 0 || _etype != null) {
            return 2;
        }
        if (_full == 2) {
            return 3;
    ...
    private String renderNavBar() throws IOException {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            if (i == 4) {
                continue;
            } // show compact mode for all routers
            if (i == 5 || i == 6) {
                continue;
            } // hide standard Leasesets tab in normal/adv. mode,
            if (i == 10 || i == 11 || _context.netDb().getRouters().size() == 0) {
                continue;
            }
            if (i == tab || (i == 3 && tab == 4) || (i == 7 && (tab == 5 || tab == 6))) {
                buf.append("<span class=tab2>").append(_t(titles[i]));
            } // we are there
            else { // we are not there, make a link
                buf.append("<span class=tab>").append("<a href=\"netdb").append(links[i]).append("\">").append(_t(titles[i])).append("</a>");
            }
            buf.append("</span>\n");
        }
        buf.append("</div>\n");
    ...
    private void renderLookupForm() throws IOException {
        ...
        buf.append("<form action=/netdb method=GET id=netdbSearch>\n<input type=hidden name=nonce value=").append(_newNonce).append(">\n<table id=netdblookup><tr><th colspan=4>").append(_t("Network Database Search")).append("</th></tr>\n<tr><td><b>").append(_t("Capabilities")).append("</b></td><td><input type=text name=caps title=\"").append(_t("e.g. f or XOfR")).append("\"></td>\n<td><b>").append(_t("Cost")).append("</b></td><td><input type=text name=cost></td></tr>\n<tr><td><b>").append(_t("Country")).append("</b></td><td><select name=\"c\"><option value=\"\" selected></option>");
        ...
        buf.append("</select></td>") .append("<td><b>") .append(_t("Country Codes"))
                .append("</b></td><td><input type=text name=cc title=\"e.g. cn hk\"></td></tr>\n")
                .append("<tr><td><b>")
                .append(_t("Hash Prefix"))
                .append("</b></td><td><input type=text name=r></td>\n")
                .append("<td><b>")
                .append(_t("IP Address"))
                .append("</b></td><td><input type=text name=ip ")
                .append("title=\"")
                .append(_t("IPv4 or IPv6, /24,/16,/8 suffixes optional for IPv4, prefix ok for IPv6"))
                .append("\"></td></tr>\n")
                .append("<tr><td><b>")
                .append(_t("Hostname or b32"))
                .append("</b></td><td><input type=text name=ls></td>\n")
                .append("<td><b>")
                .append(_t("Router Family"))
                .append("</b></td><td><input type=text name=fam></td></tr>\n")
                .append("<tr><td><b>")
                .append(_t("IPv6 Prefix"))
                .append("</b></td><td><input type=text name=ipv6></td>\n")
                .append("<td><b>MTU</b></td><td><input type=text name=mtu></td></tr>\n")
                .append("<tr><td><b>")
                .append(_t("Single port or range"))
                .append("</b></td><td><input type=text name=port></td>\n")
                .append("<td><b>")
                .append(_t("Signature Type"))
                .append("</b></td><td><select name=type><option value=\"\" selected></option>");
        ...
        buf.append("<tr><td><b>") .append(_t("Router Version")) .append("</b></td><td><input type=text name=v></td>\n")
                .append("<td><b>")
                .append(_t("Transport"))
                .append("</b></td><td><select name=tr><option value=\"\" selected>")
                .append("<option value=NTCP2>NTCP2</option>\n")
                .append("<option value=SSU>SSU</option>\n")
                .append("<option value=SSU2>SSU2</option>\n")
                .append("</select></td></tr>\n")
                .append("<tr><td colspan=4 class=subheading><b>")
                .append(_t("Add Sybil analysis (must pick at least one above)"))
                .append("</b></td></tr>\n")
                .append("<tr id=sybilSearch><td><b>")
                .append(_t("Sybil close to"))
                .append("</b></td><td colspan=3><input type=text name=sybil2 ")
                .append("title=\"")
                .append(_t("Router hash, destination hash, b32, or from address book"))
                .append("\">&nbsp; ")
                .append("<label for=closetorouter><b>")
                .append(_t("or Sybil close to this router"))
                .append("</b></label>")
