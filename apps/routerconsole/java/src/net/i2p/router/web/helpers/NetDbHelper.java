...
public class NetDbHelper extends FormHandler {
    ...
    private String renderNavBar() {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            if (i == 10 || i == 11 || _context.netDb().getRouters().isEmpty()) {continue;}
    ...
    private void renderLookupForm() throws IOException {
        ...
        buf.append("<tr><td><b>").append(_t("Router Version")).append("</b></td><td><input type=text name=v></td>\n")
           ...
           .append("<option value=\"NTCP2_0\">NTCP2+MLKEM (any)</option>\n")
           .append("<option value=\"NTCP2_3\">NTCP2+MLKEM512</option>\n")
           .append("<option value=\"NTCP2_4\">NTCP2+MLKEM768</option>\n")
           .append("<option value=\"NTCP2_5\">NTCP2+MLKEM1024</option>\n")
