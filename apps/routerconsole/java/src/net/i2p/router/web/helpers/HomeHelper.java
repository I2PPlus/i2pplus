...
public class HomeHelper extends HelperBase {
    ...
    static final String DEFAULT_SERVICES = _x("Addressbook") + S
                    + _x("Manage your I2P hosts file here (I2P domain name resolution)")
                    + S
                    + "/dns?book=router&filter=latest"
                    + S
                    + I
                    + "addressbook.svg"
                    + S
                    ...
                    + _x("Manage Plugins")
                    + S
                    + _x("Install and configure I2P plugins")
                    + S
                    + "/configplugins"
                    + S
                    + I
                    ...
                    + _x("NetDb Search")
                    + S
                    + _x("Network database search tool")
                    + S
                    + "/netdb?f=4"
                    + S
                    + I
                    ...
                    + _x("Network Database")
                    + S
                    + _x("Show list of all known I2P routers")
                    + S
                    + "/netdb"
                    + S
                    + I
                    ...
                    + _x("Peer Profiles")
                    + S
                    + _x("List of recently connected peers with profiling info")
                    + S
                    + "/profiles?f=1"
                    + S
                    + I
                    ...
                    + _x("Router Info")
                    + S
                    + _x("Summary of router properties")
                    + S
                    + "/info"
                    + S
                    + I
                    ...
                    + _x("Router Updates")
                    + S
                    + _x("Configure update URLs and policy")
                    + S
                    + "/configupdate"
                    + S
                    + I
                    ...
                    + _x("Torrents")
                    + S
                    + _x("Built-in anonymous BitTorrent Client")
                    + S
                    + "/torrents"
                    + S
                    + I
                    ...
                    + _x("Tunnel Manager")
                    + S
                    + _x("Manage server and client tunnels")
                    + S
                    + "/tunnelmanager"
                    + S
                    + I
                    ...
                    + _x("Web Server")
                    + S
                    + _x("Local web server for hosting your own content on I2P")
                    + S
                    + "http://127.0.0.1:7658/"
                    + S
                    + I
    ...
    static final String NEWINSTALL_SERVICES = _x("Addressbook") + S
                    + _x("Manage your I2P hosts file here (I2P domain name resolution)")
                    + S
                    + "/dns?book=router&filter=latest"
                    + S
                    ...
                    + "addressbook.svg"
                    + S
                    + _x("Configure Bandwidth")
                    + S
                    + _x("I2P Bandwidth Configuration")
                    + S
                    + "/config"
                    + S
                    + I
                    ...
                    + _x("Configure UI")
                    + S
                    + _x("Select console theme &amp; language &amp; set optional console password")
                    + S
                    + "/configui"
                    + S
                    + I
                    + "ui.svg"
                    + S
                    + _x("Customize Sidebar")
                    + S
                    + _x("Customize the sidebar by adding or removing or repositioning elements")
                    + S
                    + "/configsidebar"
                    + S
                    + I
                    ...
                    + _x("Wizard")
                    + S
                    + _x("Configuration and bandwidth tester")
                    + S
                    + "/wizard"
                    + S
                    + I
    ...
    static final String ADVANCED_SERVICES = _x("Addressbook") + S
                    + _x("Manage your I2P hosts file here (I2P domain name resolution)")
                    + S
                    + "/dns?book=router&filter=latest"
                    + S
                    ...
                    + _x("Advanced Config")
                    + S
                    + _x("Advanced router configuration")
                    + S
                    + "/configadvanced"
                    + S
                    + I
                    ...
                    + _x("Clients")
                    + S
                    + _x("Start or stop Router clients")
                    + S
                    + "/configclients"
                    + S
                    + I
    ...
    static final String DEFAULT_FAVORITES =
            ...
            // I2P specific
            _x("I2P+ Bug Reports") + S + _x("Bug tracker")
                    + S
                    + "https://github.com/I2PPlus/i2pplus/issues"
                    + S
                    + I
                    + "bug.svg"
                    + S
                    + _x("I2P FAQ")
                    + S
                    + _x("Frequently Asked Questions")
                    + S
                    + "http://i2p-projekt.i2p/faq"
                    + S
                    + I
                    + "faq.svg"
                    + S
                    ...
                    + "i2pmetrics.i2p"
                    + S
                    + _x("Historical infrastructure data from the I2P network")
                    + S
                    + "http://i2pmetrics.i2p/"
                    + S
                    + I
                    ...
                    + _x("Javadocs")
                    + S
                    + _x("I2P+ API documentation")
                    + S
                    + "http://javadoc.skank.i2p/"
                    + S
                    + I
                    + "helplink.svg"
                    + S
                    ...
                    "drop.i2p"
                    + S
                    + _x("Transient server-encrypted filesharing and pastebin")
                    + S
                    + "http://drop.i2p/"
                    + S
                    + I
                    ...
                    + "git.idk.i2p"
                    + S
                    + _x("Official I2P Git repository")
                    + S
                    + "http://git.idk.i2p/explore/projects"
                    + S
                    + I
                    + "gitlab.svg"
                    + S
                    ...
                    // torrent trackers
                    _x("Postman's Tracker")
                    + S
                    + _x("BitTorrent tracker")
                    + S
                    + "http://tracker2.postman.i2p/"
                    + S
                    + I
                    + "eepsites/postman.svg"
                    + S
                    +
                    ...
                    "notbob.i2p"
                    + S
                    + _x("List of active eepsites and uptime monitor")
                    + S
                    + "http://notbob.i2p/"
                    + S
                    + I
                    ...
                    + "reg.i2p"
                    + S
                    + _x("I2P Domain Name Registration")
                    + S
                    + "http://reg.i2p/"
                    + S
                    + I
                    ...
                    _x("I2P Forum")
                    + S
                    + _x("I2P-related community forums")
                    + S
                    + "http://i2pforum.i2p/"
                    + S
                    + I
                    ...
                    + "ramble.i2p"
                    + S
                    + _x("Cross-network micro-blogging &amp; forums &amp; wiki")
                    + S
                    + "http://ramble.i2p/"
                    + S
                    + I
                    ...
                    + "shreddit"
                    + S
                    + _x("Alternative privacy-focused front-end for Reddit")
                    + S
                    + "http://shreddit.i2p/"
                    + S
                    + I
                    + "eepsites/shreddit.svg"
                    + S
                    +
                    ...
                    "major.i2p"
                    + S
                    + _x("IRC Logs for multiple networks")
                    + S
                    + "http://major.i2p/"
                    + S
                    + I
                    ...
                    + "qwik.i2p"
                    + S
                    + _x("Landing page for various services")
                    + S
                    + "http://qwik.i2p/"
                    + S
                    + I
                    ...
                    + "radio.r4sas.i2p"
                    + S
                    + _x("Streaming radio service")
                    + S
                    + "http://radio.r4sas.i2p/"
                    + S
                    + I
                    + "eepsites/radio.svg"
                    + S
                    + "stormycloud.i2p"
                    + S
                    + _x("Privacy-focused not-for-profit organization")
                    + S
                    + "http://stormycloud.i2p/"
                    + S
                    + I
                    + "eepsites/stormycloud.svg"
                    + S
                    + _x("translate")
                    + S
                    + _x("Text translation engine")
                    + S
                    + "http://translate.i2p/"
                    + S
                    + I
                    + "eepsites/translate.svg"
                    + S
                    + "incognet.i2p"
                    + S
                    + _x("Provider of privacy respecting web hosting and VPN services")
                    + S
                    + "http://incognet.i2p/"
                    + S
                    + I
                    ...
                    "DuckDuckGo"
                    + S
                    + _x("DuckDuckGo Search Engine (no javascript)")
                    + S
                    + "http://duckduckgo.i2p/"
                    + S
                    + I
                    + "eepsites/duckduckgo.svg"
                    + S
                    + "Mojeek"
                    + S
                    + _x("Privacy-focused Clearnet Search Engine")
                    + S
                    + "http://mojeek.i2p/"
                    + S
                    + I
                    ...
                    + "Shinobi"
                    + S
                    + _x("I2P Web Search Engine")
                    + S
                    + "http://shinobi.i2p/"
                    + S
                    + I
                    + "eepsites/shinobi.png"
                    + S
                    +
                    ...
                    + "mathworld.i2p"
                    + S
                    + _x("Wolfram's Online Math Reference")
                    + S
                    + "http://mathworld.i2p/"
                    + S
                    + I
                    + "eepsites/mathworld.svg"
                    + S
                    + "mdn.i2p"
                    + S
                    + _x("Mozilla Developer Network")
                    + S
                    + "http://mdn.i2p/"
                    + S
                    + I
                    ...
                    + "Philosopedia"
                    + S
                    + _x("Internet Encyclopedia of Philosophy")
                    + S
                    + "http://philosopedia.i2p/"
                    + S
                    + I
                    + "eepsites/books.svg"
                    + S
                    + "plato.i2p"
                    + S
                    + _x("Standford Encyclopedia of Philosophy")
                    + S
                    + "http://plato.i2p/"
                    + S
                    + I
                    ...
                    + _x("SimplifiedGuide")
                    + S
                    + _x("Computing-related tutorials")
                    + S
                    + "http://simplified.i2p/"
                    + S
                    + I
                    ...
                    + "w3schools.i2p"
                    + S
                    + _x("Web technology reference and learning site")
                    + S
                    + "http://w3schools.i2p/"
                    + S
                    + I
                    + "eepsites/w3schools.svg"
                    + S
                    + "wikiless.i2p"
                    + S
                    + _x("Alternative Wikipedia front-end focused on privacy")
                    + S
                    + "http://wikiless.i2p/"
                    + S
                    + I
                    ...
                    + _x("WorldAtlas")
                    + S
                    + _x("World atlas including geography facts &amp; flags")
                    + S
                    + "http://worldatlas.i2p/"
                    + S
                    + I
                    ...
                    "ArsTechnica"
                    + S
                    + _x("Technology News &amp; more...")
                    + S
                    + "http://arstechnica.i2p/"
                    + S
                    + I
                    + "eepsites/arstechnica.svg"
                    + S
                    + "BenthamsGaze"
                    + S
                    + _x("Information Security Research &amp; Education")
                    + S
                    + "http://benthamsgaze.i2p/"
                    + S
                    + I
                    + "eepsites/benthamsgaze.png"
                    + S
                    + _x("DigitalTrends")
                    + S
                    + _x("Tech News &amp; Reviews")
                    + S
                    + "http://digitaltrends.i2p/"
                    + S
                    + I
                    + "eepsites/digitaltrends.svg"
                    + S
                    + "EFF"
                    + S
                    + _x("Defending your rights in the digital world")
                    + S
                    + "http://eff.i2p/"
                    + S
                    + I
                    ...
                    + "EllipticNews"
                    + S
                    + _x("The Elliptic Curve Cryptography Blog")
                    + S
                    + "http://ellipticnews.i2p/"
                    + S
                    + I
                    + "news.svg"
                    + S
                    + "Hackaday"
                    + S
                    + _x("Fresh hacks every day")
                    + S
                    + "http://hackaday.i2p/"
                    + S
                    + I
                    + "eepsites/hackaday.svg"
                    + S
                    + _x("HackerNews")
                    + S
                    + _x("Computer related news aggregation")
                    + S
                    + "http://hackernews.i2p/"
                    + S
                    + I
                    + "news.svg"
                    + S
                    + _x("HongKongFreePress")
                    + S
                    + _x("Independent &amp; impartial news for Hong Kong")
                    + S
                    + "http://hongkongfreepress.i2p/"
                    + S
                    + I
                    + "eepsites/hkfp.svg"
                    + S
                    + _x("JStorDaily")
                    + S
                    + _x("Where news meets its scholarly match")
                    + S
                    + "http://jstordaily.i2p/"
                    + S
                    + I
                    + "eepsites/jstordaily.png"
                    + S
                    + _x("Jurist")
                    + S
                    + _x("Legal News &amp; Commentary")
                    + S
                    + "http://jurist.i2p/"
                    + S
                    + I
                    ...
                    + _x("KrebsOnSecurity")
                    + S
                    + _x("In-depth security news &amp; investigation")
                    + S
                    ...
                    + "MotherJones"
                    + S
                    + _x("Smart &amp; fearless journalism")
                    + S
                    + "http://motherjones.i2p/"
                    + S
                    + I
                    + "eepsites/motherjones.svg"
                    + S
                    + _x("NewStatesman")
                    + S
                    + _x("Politics &amp; Current Affairs magazine")
                    + S
                    + "http://newstatesman.i2p/"
                    + S
                    + I
                    + "eepsites/newstatesman.svg"
                    + S
                    + _x("OpenDemocracy")
                    + S
                    + _x("Independent International Media Platform")
                    + S
                    + "http://opendemocracy.i2p/"
                    + S
                    + I
                    + "news.svg"
                    + S
                    + _x("RightToPrivacy")
                    + S
                    + _x("Online privacy &amp; tech blog")
                    + S
                    + "http://righttoprivacy.i2p/"
                    + S
                    + I
                    + "eepsites/rtp.webp"
                    + S
                    + "RollingStone"
                    + S
                    + _x("Lifestyle magazine")
                    + S
                    + "http://rollingstone.i2p/"
                    + S
                    + I
                    + "eepsites/rollingstone.svg"
                    + S
                    + _x("SchneierOnSecurity")
                    + S
                    + _x("Internationally renowned security technologist")
                    + S
                    + "http://schneieronsecurity.i2p/"
                    + S
                    + I
                    + "eepsites/schneier.png"
                    + S
                    + _x("ScienceDaily")
                    + S
                    + _x("Latest scientific research news")
                    + S
                    + "http://sciencedaily.i2p/"
                    + S
                    + I
                    + "eepsites/science.svg"
                    + S
                    + "SoylentNews"
                    + S
                    + _x("Community-driven tech news")
                    + S
                    + "http://soylentnews.i2p/"
                    + S
                    + I
                    + "news.svg"
                    + S
                    ...
                    + S
                    + I
                    + "eepsites/slashdot.svg"
                    + S
                    + "SlashGear"
                    + S
                    + _x("Technology news &amp; reviews")
                    + S
                    + "http://slashgear.i2p/"
                    + S
                    + I
                    + "eepsites/slashgear.svg"
                    + S
                    + _x("TaipeiTimes")
                    + S
                    + _x("News from the Taiwan Capital")
                    + S
                    + "http://taipeitimes.i2p/"
                    + S
                    + I
                    + "news.svg"
                    + S
                    ...
                    + _x("TheConversation")
                    + S
                    + _x("Academic commentary and essays")
                    + S
                    + "http://theconversation.i2p/"
                    + S
                    + I
                    + "eepsites/theconversation.svg"
                    + S
                    + _x("TheGuardian")
                    + S
                    + _x("Global News")
                    + S
                    + "http://theguardian.i2p/"
                    + S
                    + I
                    + "eepsites/theguardian.svg"
                    + S
                    + _x("TheMarkup")
                    + S
                    + _x("Watching Big Tech...")
                    + S
                    + "http://themarkup.i2p/"
                    + S
                    + I
                    ...
                    + _x("TheMoscowTimes")
                    + S
                    + _x("Independent Journalism from Russia")
                    + S
                    + "http://themoscowtimes.i2p/"
                    + S
                    + I
                    + "news.svg"
                    + S
                    ...
                    + _x("Politics &amp; Current Affairs magazine")
                    + S
                    + "http://newrepublic.i2p/"
                    + S
                    + I
                    + "eepsites/newrepublic.svg"
                    + S
                    + "TorrentFreak"
                    + S
                    + _x("Filesharing &amp; copyright news")
                    + S
                    + "http://torrentfreak.i2p/"
                    + S
                    + I
                    + "eepsites/torrentfreak.svg"
                    + S
                    + _x("WashingtonInstitute")
                    + S
                    + _x("Advancing a balanced &amp; realistic understanding of American interests in the Middle East")
                    + S
                    + "http://washingtoninstitute.i2p/"
                    + S
                    + I
                    + "eepsites/washingtoninstitute.svg"
                    + S
                    +
    ...
    private String renderApps(Collection<App> apps) {
        ...
        for (App app : apps) {
            ...
            } else if ((!embedApps && (app.url.contains("webmail") || app.url.contains("torrents") || app.url.contains("outproxy") || app.url.contains("bote") || app.url.contains("orchid") || app.url.contains("BwSchedule"))) || app.url.endsWith("tracker/") || app.url.contains(".i2p") || app.url.contains("history.txt") || app.url.contains("prometheus/status.html")) {
                url = app.url + "\" target=_blank class=\"extlink";
            } else {
                url = app.url;
                if (url.contains("/dns")) {
            ...
            buf.append("\n<div class=\"applink");
            if (url.contains("i2pmetrics") || url.contains("paste.r4sas") || url.contains("speedtest") || url.contains("vuldb") || url.contains("meduza") || url.contains("mdn") || url.contains("ardullm") || url.contains("w3schools") || url.contains("translate.idk")) {
                buf.append(" js");
            }
            buf.append("\" style=display:inline-block; text-align:center><div class=appicon><a href=\"").append(url).append("\" tabindex=-1><img alt=\"\" title=\"").append(app.desc).append("\" src=\"").append(app.icon).append("\" width=32 height=32></a></div><table><tr><td><div class=applabel><a href=\"").append(url).append("\" title=\"").append(app.desc).append("\">").append(app.name).append("</a></div></td></tr></table></div>");
        }
        buf.append("</div>\n");
        return buf.toString();
    }
    ...
    private String renderConfig(Collection<App> apps) {
        ...
        buf.append("<table class=homelinkedit><tr><th class=center title=\"").append(_t("Mark for deletion")).append("\">").append(_t("Remove")).append("</th><th></th><th>").append(_t("Name")).append("</th><th>").append(_t("URL")).append("</th></tr>\n");
        for (App app : apps) {
            String url = DataHelper.escapeHTML(app.url);
            buf.append("<tr><td class=center><input type=checkbox class=optbox name=\"delete_").append(app.name).append("\" id=\"");
            if (url.contains("%s")) {
                buf.append("search_");
            }
            ...
            buf.append(app.name.replace(" ", "_").replace("\'", "")).append("\">").append(DataHelper.escapeHTML(app.name)).append("</label></td><td><a href=\"").append(url).append("\">");
        ...
        buf.append("<tr class=addnew><td colspan=2><b>").append(_t("Add")).append(":</b></td><td><input type=text name=nofilter_name></td><td><input type=text size=40 name=nofilter_url></td></tr></table>\n");
        return buf.toString();
    }
    ...
    private static class AppComparator implements Comparator<App>, Serializable {
        public int compare(App l, App r) {
            return l.name.toLowerCase(Locale.ROOT).compareTo(r.name.toLowerCase(Locale.ROOT));
        }
    }
}
