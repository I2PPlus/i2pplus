#!/usr/bin/env python3
"""
Send a RAW message to a peer via the SAM v3 UDP server.

Usage:  ./samOut.py <destination> [name] [message]
          destination : base64 I2P destination from samIn.py
          name        : sending session nickname (default: rawSamForward)
          message     : payload text (default: "This is a nice message")

Example: ./samOut.py <dest-from-samIn.py> myRawOut "hello"
"""
