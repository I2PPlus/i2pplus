...
public final class GraphicsUtils {
    ...
    /**
     * Returns a shape that is (more or less) equivalent to the supplied shape. For some known shape
     * implementations ({@code Line2D}, {@code Rectangle2D}, {@code RoundRectangle2D}, {@code
     * Arc2D}, {@code Ellipse2D}, and {@code Polygon}) the copy will be an instance of that class.
     * For other shapes, a {@code Path2D} containing the outline of the shape is returned.
     *
    ...
    public static GeneralPath createPolygon(
            int[] xPoints, int[] yPoints, int nPoints, boolean close) {
    ...
    /**
     * Converts a rendered image to a {@code BufferedImage}. This utility method has come from a
     * forum post by Jim Moore at:
     *
