...
public interface DataHolder {
    ...
    /**
     * Constant that defines the default {@link RrdDbPool} usage policy. Defaults to <code>false
     * </code> (i.e. the pool will not be used to fetch data from RRD files)
     */
    ...
    /**
     * Sets the time when the graph should start. Time in seconds since epoch (1970-01-01) is
     * required. Negative numbers are relative to the current time.
     *
     ...
     */
    void datasource(
            String name, URI rrdUri, String dsName, ConsolFun consolFun, RrdBackendFactory backend);
