...
public class I2PTunnelIRCClient extends I2PTunnelClientBase {
                ...
                try {
                    ...
                    if (addr.isUnresolved()) {
                        ...
                        if (name.length() == 60 && name.endsWith(".b32.i2p")) {
                            l.log("[IRC Client] Warning - Could not resolve " + name.substring(0,16) + "...b32.i2p" +
                                  " -> Will retry when connecting...");
                        } else {
                            l.log("[IRC Client] Warning - Could not resolve " + name + " -> Not found in addressbook");
                        }
                    }
    ...
    protected void clientConnectionRun(Socket s) {
        ...
        try {
            ...
            in.setPriority(Thread.MAX_PRIORITY);
            in.start();
