...
public class MimeTypeDetector {
    ...
    public static String detectMimeType(String url) {
        ...
        if (lcUrl.endsWith(".3g2")) {
            return "video/3gpp2";
        } else if (lcUrl.endsWith(".3gp")) {
            return "video/3gpp";
        } else if (lcUrl.endsWith(".aac")) {
            return "audio/aac";
        } else if (lcUrl.endsWith(".abw")) {
            return "application/x-abiword";
        } else if (lcUrl.endsWith(".arc")) {
            return "application/x-freearc";
        } else if (lcUrl.endsWith(".avif")) {
            return "image/avif";
        } else if (lcUrl.endsWith(".avi")) {
            return "video/x-msvideo";
        } else if (lcUrl.endsWith(".azw")) {
            return "application/vnd.amazon.ebook";
        } else if (lcUrl.endsWith(".bin")) {
            return "application/octet-stream";
        } else if (lcUrl.endsWith(".bmp")) {
            return "image/bmp";
        } else if (lcUrl.endsWith(".bz")) {
            return "application/x-bzip";
        } else if (lcUrl.endsWith(".bz2")) {
            return "application/x-bzip2";
        } else if (lcUrl.endsWith(".cda")) {
            return "application/x-cdf";
        } else if (lcUrl.endsWith(".css")) {
            return "text/css";
        } else if (lcUrl.endsWith(".csv")) {
            return "text/csv";
        } else if (lcUrl.endsWith(".doc")) {
            return "application/msword";
        } else if (lcUrl.endsWith(".docx")) {
            return "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
        } else if (lcUrl.endsWith(".eot")) {
            return "application/vnd.ms-fontobject";
        } else if (lcUrl.endsWith(".epub")) {
            return "application/epub+zip";
        } else if (lcUrl.endsWith(".gif")) {
            return "image/gif";
        } else if (lcUrl.endsWith(".gz")) {
            return "application/gzip";
        } else if (lcUrl.endsWith(".htm") || lcUrl.endsWith(".html")) {
            return "text/html";
        } else if (lcUrl.endsWith(".ico")) {
            return "image/vnd.microsoft.icon";
        } else if (lcUrl.endsWith(".ics")) {
            return "text/calendar";
        } else if (lcUrl.endsWith(".jar")) {
            return "application/java-archive";
        } else if (lcUrl.endsWith(".jpeg") || lcUrl.endsWith(".jpg")) {
            return "image/jpeg";
        } else if (lcUrl.endsWith(".json")) {
            return "application/json";
        } else if (lcUrl.endsWith(".jsonld")) {
            return "application/ld+json";
        } else if (lcUrl.endsWith(".js") || lcUrl.endsWith(".mjs")) {
            return "text/javascript";
        } else if (lcUrl.endsWith(".mid") || lcUrl.endsWith(".midi")) {
            return "audio/midi";
        } else if (lcUrl.endsWith(".mp3")) {
            return "audio/mpeg";
        } else if (lcUrl.endsWith(".mp4")) {
            return "video/mp4";
        } else if (lcUrl.endsWith(".mpeg")) {
            return "video/mpeg";
        } else if (lcUrl.endsWith(".mpkg")) {
            return "application/vnd.apple.installer+xml";
        } else if (lcUrl.endsWith(".ods")) {
            return "application/vnd.oasis.opendocument.spreadsheet";
        } else if (lcUrl.endsWith(".odt")) {
            return "application/vnd.oasis.opendocument.text";
        } else if (lcUrl.endsWith(".odp")) {
            return "application/vnd.oasis.opendocument.presentation";
        } else if (lcUrl.endsWith(".oga")) {
            return "audio/ogg";
        } else if (lcUrl.endsWith(".ogv")) {
            return "video/ogg";
        } else if (lcUrl.endsWith(".ogx")) {
            return "application/ogg";
        } else if (lcUrl.endsWith(".opus")) {
            return "audio/opus";
        } else if (lcUrl.endsWith(".otf")) {
            return "font/otf";
        } else if (lcUrl.endsWith(".pdf")) {
            return "application/pdf";
        } else if (lcUrl.endsWith(".php")) {
            return "application/x-httpd-php";
        } else if (lcUrl.endsWith(".png")) {
            return "image/png";
        } else if (lcUrl.endsWith(".ppt")) {
            return "application/vnd.ms-powerpoint";
        } else if (lcUrl.endsWith(".pptx")) {
            return "application/vnd.openxmlformats-officedocument.presentationml.presentation";
        } else if (lcUrl.endsWith(".rar")) {
            return "application/x-rar-compressed";
        } else if (lcUrl.endsWith(".rtf")) {
            return "application/rtf";
        } else if (lcUrl.endsWith(".sh")) {
            return "application/x-sh";
        } else if (lcUrl.endsWith(".svg")) {
            return "image/svg+xml";
        } else if (lcUrl.endsWith(".tar")) {
            return "application/x-tar";
        } else if (lcUrl.endsWith(".tif") || lcUrl.endsWith(".tiff")) {
            return "image/tiff";
        } else if (lcUrl.endsWith(".ts")) {
            return "video/mp2t";
        } else if (lcUrl.endsWith(".txt")) {
            return "text/plain";
        } else if (lcUrl.endsWith(".ttf")) {
            return "font/ttf";
        } else if (lcUrl.endsWith(".vsd")) {
            return "application/vnd.visio";
        } else if (lcUrl.endsWith(".wav")) {
            return "audio/wav";
        } else if (lcUrl.endsWith(".weba")) {
            return "audio/webm";
        } else if (lcUrl.endsWith(".webm")) {
            return "video/webm";
        } else if (lcUrl.endsWith(".woff")) {
            return "font/woff";
        } else if (lcUrl.endsWith(".woff2")) {
            return "font/woff2";
        } else if (lcUrl.endsWith(".xhtml")) {
            return "application/xhtml+xml";
        } else if (lcUrl.endsWith(".xls")) {
            return "application/vnd.ms-excel";
        } else if (lcUrl.endsWith(".xlsx")) {
            return "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        } else if (lcUrl.endsWith(".xml")) {
            return "application/xml";
        } else if (lcUrl.endsWith(".xul")) {
            return "application/vnd.mozilla.xul+xml";
        } else if (lcUrl.endsWith(".zip")) {
