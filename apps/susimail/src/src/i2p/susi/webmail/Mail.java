                ...
                try {
                    ...
                    for (int j = 0; j < headerLines.length; j++) {
                        ...
                        if (hlc.startsWith("from:")) {
                            ...
                            else if (lt < 0 && shortSender.contains("@")) {shortSender = "<".concat(shortSender).concat(">");}
                            ...
                            if (trim) {shortSender = shortSender.concat("&hellip;");}  // must be after html encode
                        }
                            ...
                            if (trim) {shortSubject = shortSubject.concat("&hellip;");}  // must be after html encode
                        }
